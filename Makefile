...
SOURCES       = entity/entity.cpp \
		...
		entity/contromodule/strategy/basics/sslstrategy_halt.cpp moc_playbook.cpp \
		moc_behaviour.cpp
OBJECTS       = entity.o \
		world.o \
		worldmapupdater.o \
