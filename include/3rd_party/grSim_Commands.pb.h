...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_grSim_5fCommands_2eproto 
...
class grSim_Robot_Command : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:grSim_Robot_Command) */ {
 public:
  ...
  inline grSim_Robot_Command* New() const final {
    return CreateMaybeMessage<grSim_Robot_Command>(NULL);
  }
...
class grSim_Commands : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:grSim_Commands) */ {
 public:
  ...
  inline grSim_Commands* New() const final {
    return CreateMaybeMessage<grSim_Commands>(NULL);
  }
