...
#ifndef PROTOBUF_INCLUDED_ssl_5fgame_5fevent_2eproto
#define PROTOBUF_INCLUDED_ssl_5fgame_5fevent_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_ssl_5fgame_5fevent_2eproto 
...
class Game_Event_Originator : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Game_Event.Originator) */ {
 public:
  ...
  inline Game_Event_Originator* New() const final {
    return CreateMaybeMessage<Game_Event_Originator>(NULL);
  }

  Game_Event_Originator* New(::google::protobuf::Arena* arena) const final {
...
class Game_Event : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Game_Event) */ {
 public:
  ...
  inline Game_Event* New() const final {
    return CreateMaybeMessage<Game_Event>(NULL);
  }

  Game_Event* New(::google::protobuf::Arena* arena) const final {
...
inline const ::Game_Event_Originator& Game_Event::originator() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::Game_Event_Originator*>(
      &::_Game_Event_Originator_default_instance_);
}
...
#endif  // PROTOBUF_INCLUDED_ssl_5fgame_5fevent_2eproto
