...
Suassuna::Suassuna(quint8 teamId, Colors::Color teamColor, FieldSide fieldSide, MRCConstants *mrcconstants)
    : _teamId(teamId), _teamColor(teamColor), _fieldSide(fieldSide), _mrcconstants(mrcconstants){
    // Create controller
    _ctr = new Controller();
